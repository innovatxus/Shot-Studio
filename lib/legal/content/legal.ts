    ...
    sections: [
      {
        ...
        paragraphs: {
          en: [
            "This Data Processing Agreement (“DPA”) forms part of the Terms of Service between Innovatx (trading as ShotStudio) and any customer who uses the Service to process personal data. It applies in addition to, and does not replace, the Privacy Policy.",
            "Roles: for account data whose purposes we determine, ShotStudio acts as controller. For images and prompts you submit for processing, you determine the purpose and means and act as controller; ShotStudio acts as processor and processes that content only on your documented instructions, which your use of the Service constitutes.",
            "Subject matter and duration: the subject matter is the AI processing of images and associated prompts you submit; processing lasts for the term of your Account and the retention periods set out in Section 8 of the Privacy Policy.",
            "Nature and purpose: receiving uploads, routing them to the selected AI tool or inference provider, returning the AI Output, and storing outputs you choose to save to your library.",
            "Categories of data: images and any personal data they contain (which may include facial images), prompts, account identifiers, and usage metadata. Data subjects: you, your personnel, and any individuals depicted in the images you upload.",
            "Our obligations as processor: process only on your instructions; ensure personnel are bound by confidentiality; apply the security measures in Annex II; assist you with data-subject requests and breach notification; and delete or return content on termination, subject to legal retention.",
            "Unlawful instructions: we will inform you and are not obliged to carry out an instruction we reasonably believe infringes Egyptian Personal Data Protection Law No. 151/2020 or other applicable law.",
          ],
          ar: [
            "This Data Processing Agreement (“DPA”) forms part of the Terms of Service between Innovatx (trading as ShotStudio) and any customer who uses the Service to process personal data. It applies in addition to, and does not replace, the Privacy Policy.",
            "Roles: for account data whose purposes we determine, ShotStudio acts as controller. For images and prompts you submit for processing, you determine the purpose and means and act as controller; ShotStudio acts as processor and processes that content only on your documented instructions, which your use of the Service constitutes.",
      ...
      },
      {
        ...
        paragraphs: {
          en: [
            "You give general authorisation for the sub-processors listed on our public Sub-processors page. We remain liable for their performance of the obligations in this DPA.",
            "We will give at least 30 days' notice before adding or replacing a sub-processor. If you object on reasonable data-protection grounds within that period, you may terminate the affected part of the Service without penalty for the unused portion of your term.",
      ...
      },
      {
        ...
        paragraphs: {
          en: [
            ...
            "Personal data breach: we will notify you without undue delay after becoming aware of a breach affecting content processed on your behalf, with the information reasonably available to us, so you can meet your own notification duties.",
            "Audit: on reasonable written notice and no more than once in any twelve-month period, we will make available the information necessary to demonstrate compliance with this DPA, including our current security documentation at /trust/security.",
          ],
          ar: [
            "We apply the technical and organisational measures set out in Annex II, which mirror Section 11 of the Privacy Policy. We review them at least annually and may update them provided the level of protection is not reduced.",
            "Personal data breach: we will notify you without undue delay after becoming aware of a breach affecting content processed on your behalf, with the information reasonably available to us, so you can meet your own notification duties.",
